...
class About extends Component {
    ...
    render(){
    	...
    	const content = props=><motion.div variants={variants}>
			...
			I have recently graduated from <b>University of Sydney</b> with a <b>Bachelor of Computer Science and Technology(Advanced)(Honours)</b> degree(I know, it is a long title) in 2019. I am a person who enjoys solving problems and learning new skills or knowledges, and that's the reason why I pursued the advanced stream to push myself taking more challenges and landed with an 80+ WAM. I have also obtained a <b>First Class Honour</b> from my degree as well with work focusing on Static Code Analysis.<br/><br/>
			...
			I would like to thank you for visiting my site and give me a thumbs up if you like my profile ;)<br/>
